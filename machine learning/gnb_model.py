...
plt.tight_layout()
plt.savefig(os.path.join(r"C:\Users\Vignes V M\OneDrive\Desktop\clg\Semester 2\projects\EEE\graphs\classification\ml",'gnb.png'),dpi=300)
plt.show()

#save model
joblib.dump(best_model, "models/gnb_model.pkl")
